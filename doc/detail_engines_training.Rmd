...
|--------------|-------------------------------|----------------------------------|----------------------------------------------------------------|--------------|
| `lm`         | `engine_train_lm()`           | Ordinary least squares regression | `inst/templates_control/2_a_template_control_train_lm.R`       | [📄](detail_engine_train_lm.html) |
| `rf`         | `engine_train_rf()`           | Random forest via `randomForest` | `inst/templates_control/2_a_template_control_train_rf.R`       | [📄](detail_engine_train_rf.html) |
| `gbm`        | `engine_train_gbm()`          | Gradient boosting models         | `inst/templates_control/2_a_template_control_train_gbm.R`      | [📄](detail_engine_train_gbm.html) |
