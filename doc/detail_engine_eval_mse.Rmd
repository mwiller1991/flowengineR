...
subtitle: "Quantifying prediction accuracy with squared error loss"
author: "mwiller"
output:
...
> **Summary**  
> This vignette introduces the evaluation engine for **Mean Squared Error (MSE)**.  
> It explains the standardized input/output structure, demonstrates the wrapper logic, and shows how to use this engine within a `flowengineR` workflow to quantify model accuracy.
