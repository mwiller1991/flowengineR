---
title: "In Detail: Inprocessing Engine - Fairness Adversarial Debiasing"
subtitle: "Mitigating bias during training using adversarial techniques"
author: "mwiller"
output:
  rmarkdown::html_vignette:
    ...
    toc_depth: 3
vignette: >
  %\VignetteIndexEntry{In Detail: Inprocessing Engine - Fairness Adversarial Debiasing}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

> **Summary**  
> This vignette introduces the **adversarial debiasing inprocessing engine**.  
> It explains how fairness constraints are incorporated directly into model training using adversarial methods, balancing predictive performance and fairness objectives within the standardized engine structure of `flowengineR`.
...
Compatability: Currently, this engine is only tested and compatible with the included train_glm (Generalized Linear Model) and train_rf (Random Forrest) engines. Beware of the training time of the rf inside this model and the calibration has to be choosen smart or the rf is running on an error. While combining it with other training engines is theoretically possible, it requires specific modifications in how instance weights are applied and how model predictions are accessed within the training loop.
