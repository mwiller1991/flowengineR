---
title: "How to Use Engines"
subtitle: "Practical usage of engines within workflows"
author: "mwiller"
output:
  rmarkdown::html_vignette:
    ...
    toc_depth: 3
vignette: >
  %\VignetteIndexEntry{How to Use Engines}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

> **Summary**  
> This vignette introduces the **practical usage of engines**.  
> It demonstrates how engines are called within workflows, how wrappers standardize inputs and outputs, and how users can configure or replace engines to customize behavior.
...
| Training            | Trains a prediction model                          | `train_lm`, `train_gbm`              | [Details](detail_engines_train.html) |
