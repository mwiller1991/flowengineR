---
title: "In Detail: Publishing Engines"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{In Detail: Publishing Engines}
...
|------------------|--------------|---------------------------------------------------------------------------------|
| `object`         | list         | A `report` or `reportelement` object (⚠️ provided by the framework)             |
| `file_path`      | character    | Target path including filename and extension (⚠️ provided by the framework)     |
| `output_folder`  | character    | Target path privided via controller  (⚠️ transformed to file_path by the framework) |
...
## ⚙️ Available Publishing Engines

| Engine Name         | Function Name                     | Description                           | Template Path                                                      | Detail Page |
|---------------------|------------------------------------|---------------------------------------|---------------------------------------------------------------------|-------------|
| `publish_pdf_basis` | `engine_publish_pdf_basis()`      | Basic PDF exporter for full reports   | `inst/templates_control/10_a_engine_publish_pdf_basis.R`         | [📄](detail_engine_publish_pdf_basis.html) |
| `publish_excel_basis` | `engine_publish_excel_basis()`   | Exports reportelements to Excel files | `inst/templates_control/10_b_engine_publish_excel_basis.R`       | [📄](detail_engine_publish_excel_basis.html) |
...
## 🛠️ Writing Your Own Publishing Engine
...
## 🎯 Possible Use-Cases: Export Options for Different Stakeholders
