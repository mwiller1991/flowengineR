---
title: "In Detail: Engines - Report"
subtitle: "Generating structured reports from workflow outputs"
author: "mwiller"
output:
  rmarkdown::html_vignette:
    ...
    toc_depth: 3
vignette: >
  %\VignetteIndexEntry{In Detail: Engines - Report}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

> **Summary**  
> This vignette introduces the **report engines**.  
> It shows how workflow results are processed into structured report elements, enabling both human-readable summaries and integration with publishing engines.
...
|------------------|--------------|-----------------------------------------------------------------------------|
| `reportelements` | list         | Named list of precomputed reportelement outputs (⚠️ provided by the framework) |
...
## ⚙️ Available Report Engines

| Engine Name          | Function Name                    | Description                            | Template Path                                                   | Detail Page |
|----------------------|----------------------------------|----------------------------------------|------------------------------------------------------------------|-------------|
| `report_modelsummary`| `engine_report_modelsummary()`   | Structured summary report with MSE, visuals, and metrics | `inst/templates_control/9_a_template_report_modelsummary.R` | [📄](detail_engine_report_modelsummary.html) |
...
## 🛠️ Writing Your Own Report Engine
...
## 🎯 Possible Use-Case: Standardized Model Summary
