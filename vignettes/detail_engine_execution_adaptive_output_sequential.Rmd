...
subtitle: "Adaptive output execution with sequential stability checks"
author: "mwiller"
output:
...
> **Summary**  
> This vignette introduces the **sequential stability execution engine**.  
> It explains how adaptive output evaluation is performed step by step, including stability criteria and the standardized wrapper output structure for seamless integration in `flowengineR`.
