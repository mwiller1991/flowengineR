---
title: "In Detail: Engines - Postprocessing"
subtitle: "Fairness and adjustment methods applied after training"
author: "mwiller"
output:
  rmarkdown::html_vignette:
    ...
    toc_depth: 3
vignette: >
  %\VignetteIndexEntry{In Detail: Engines - Postprocessing}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---

> **Summary**  
> This vignette describes the **postprocessing engines**.  
> It covers methods that operate on model predictions after training to improve fairness or performance, showing how they adjust outputs while maintaining the standardized workflow interface.
...
|------------------------|------------------|----------------------------------------------------------------|
| `fairness_post_data`   | data.frame       | Dataset including raw predictions and protected attributes (⚠️ provided by the framework)     |
| `params`               | list             | Engine-specific parameters                                     |
| `protected_name`       | character        | Name(s) of protected attribute(s) to consider (⚠️ provided by the framework)                  |
...
## ⚙️ Available Postprocessing Engines

| Engine Name                      | Function Name                                       | Description                             | Template Path                                                                    | Detail Page |
|----------------------------------|----------------------------------------------------|-----------------------------------------|----------------------------------------------------------------------------------|--------------|
| `postprocessing_fairness_genresidual` | `engine_postprocessing_fairness_genresidual()` | Group-aware residual shifting           | `inst/templates_control/6_a_template_control_postprocessing_fairness_genresidual.R` | [📄](detail_engine_postprocessing_fairness_genresidual.html) |
...
## 🛠️ Writing Your Own Postprocessing Engine
...
## 🎯 Possible Use-Case: Group-Specific Bias Correction
