...
> It shows how different modeling approaches (e.g., linear models, GLMs, random forests) are encapsulated into standardized training functions, ensuring interoperability within the workflow.
...
| `rf`         | `engine_train_rf()`           | Random forest via `randomForest` | `inst/templates_control/4_c_template_control_train_rf.R`       | [📄](detail_engine_train_rf.html) |
| `gbm`        | `engine_train_gbm()`          | Gradient boosting models         | `inst/templates_control/4_d_template_control_train_gbm.R`      | [📄](detail_engine_train_gbm.html) |
